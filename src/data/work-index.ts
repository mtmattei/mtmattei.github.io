...
export const WORK_ROWS: WorkRow[] = [
  ...
  { name: "FRIENDSONAR", tag: "A mobile-first Find My Friends app with a retro submarine sonar aesthetic — friends plotted on an animated phosphor-green radar", meta: "2026" },
