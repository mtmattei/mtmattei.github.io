...
export const WORK_ROWS: WorkRow[] = [
  { name: "MTMATTEI.GITHUB.IO", tag: "Personal portfolio — instrument system, Astro", meta: "2026" },
  ...
  { name: "LIQUIDGLASSLAB", tag: "", meta: "2026" },
  ...
  { name: "BUILD-2026-SELECTION", tag: "Internal selection catalog of Uno Platform apps under review for Microsoft Build 2026", meta: "2026" },
  { name: "UNO-BUILDS", tag: "", meta: "2026" },
  { name: "WPF-MIGRATION-TEST", tag: "", meta: "2026" },
